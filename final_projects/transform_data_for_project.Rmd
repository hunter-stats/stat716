...
test_wine %>% 
  transmute(id = 1:nrow(.), 
         actual = quality) %>% 
  write_csv(na = "", path = 'wine/transformed/test_data_lab.csv')
```
...
test_online %>% 
  transmute(id = 1:nrow(.), 
         actual = shares) %>% 
  write_csv(na = "", path = 'onlinenews/transformed/test_data_lab.csv')
```
...
test_bank %>% 
  transmute(id = 1:nrow(.), 
         actual = y) %>% 
  write_csv(na = "", path = 'bank/transformed/test_data_lab.csv')
```
