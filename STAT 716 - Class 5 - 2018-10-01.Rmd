...
glm_fit<-glm(Direction ~ Lag1+Lag2+Lag3+Lag4+Lag5+Volume , data=Smarket ,family=binomial,subset=train_data)
lda_fit<-lda(Direction ~ Lag1+Lag2+Lag3+Lag4+Lag5+Volume , data=Smarket ,subset=train_data)
qda_fit<-qda(Direction ~ Lag1+Lag2+Lag3+Lag4+Lag5+Volume , data=Smarket, subset=train_data)
